...
const MainHomePage = () => {
  ...
  return (
    ...
    >
      ...
      <footer className="bg-blueGray-800 pt-20 pb-6 relative"> {/* Keep relative for the SVG overlay */}
        {/* SVG Overlay */}
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap text-center lg:text-left">
            ...
            <div className="w-full lg:w-4/12 px-4 mb-6 lg:mb-0"> {/* Adjusted width slightly if needed */}
              <span className="block uppercase text-blueGray-500 text-sm font-semibold mb-2 text-white">
                Quick Links
              </span>
              <ul className="list-unstyled text-blueGray-300">
                <motion.li whileHover={{ x: 5 }} className="py-1"> {/* Added padding for better hover */}
                  <a className="text-white hover:text-blueGray-400 font-semibold block text-sm transition-colors duration-150" href="#about"> {/* Original link */}
                    About Us
                  </a>
                </motion.li>
                <motion.li whileHover={{ x: 5 }} className="py-1">
                  <a className="text-white hover:text-blueGray-400 font-semibold block text-sm transition-colors duration-150" href="#services"> {/* Original link */}
                    Services
                  </a>
                </motion.li>
                <motion.li whileHover={{ x: 5 }} className="py-1">
                  <a className="text-white hover:text-blueGray-400 font-semibold block text-sm transition-colors duration-150" href="#contact"> {/* Original link */}
                    Contact Us
                  </a>
                </motion.li>
              </ul>
            </div>
             {/* Consider adding the third column back if it existed */}
