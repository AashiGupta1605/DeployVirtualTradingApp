...
const EventsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
      {/* Main Content */}
      <div className="pt-24 pb-12 max-w-7xl mx-auto">
        {/* Hero Section with proper z-index */}
        <div className="relative -ml-32 my-8 overflow-hidden bg-lightBlue-600 py-12 w-385 z-0">
          <div className="absolute inset-0 opacity-20">
            <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-30"></div>
          </div>
          
          <div className="relative w-full text-center z-20 px-4">
            <motion.div
        ...
        {/* Stats Bar with higher z-index to appear above hero section */}
        <div className="relative bg-white rounded-lg shadow-xs p-4 mb-6 grid grid-cols-3 gap-4 border border-gray-100 z-20 -mt-14 mx-4">
          {/* Active Traders Stat */}
        ...
        {/* Rest of the content with side padding */}
