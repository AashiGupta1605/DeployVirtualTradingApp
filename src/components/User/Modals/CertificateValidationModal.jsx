...
//                 courseName: 'Virtual Trading Certification',
...
//       pdf.save(`${certificateData.userName}_certificate.pdf`);
...
//                   className="w-full max-w-2xl border-2 border-gold-500 bg-white p-8 shadow-lg"
//                   style={{
...
//                       <div className="w-24 h-24 bg-lightBlue-600 rounded-full flex items-center justify-center">
...
//                     <h2 className="text-4xl font-bold text-lightBlue-600 mb-4 border-b-2 border-gold-500 pb-4 inline-block px-8">
//                       {certificateData.userName}
//                     </h2>
//                     <p className="text-gray-700 mb-8">has successfully completed the</p>
//                     <h3 className="text-2xl font-semibold text-gray-800 mb-2">{certificateData.courseName}</h3>
//                     <p className="text-gray-600 mb-8">with distinction</p>
//                   </div>
...
//                       <div className="h-16 w-32 bg-gray-200 mx-auto mb-2"></div>
//                       <p className="text-sm text-gray-600">Authorized Signature</p>
//                     </div>
//                     <div className="text-center">
//                       <div className="h-16 w-16 bg-lightBlue-600 rounded-full mx-auto mb-2 flex items-center justify-center">
