...
//                 <Tooltip title={section} isVisible={!sidebarExpanded && hoveredTooltip === `section-${section}`}>
//                   <button
//                     onMouseEnter={() => setHoveredTooltip(`section-${section}`)}
...
//                     {items.map((item) => (
//                       <Tooltip key={item.to} title={item.label} isVisible={!sidebarExpanded && hoveredTooltip === `menu-${item.to}`}>
//                         <MenuLink
//                           to={item.to}
//                           icon={item.icon}
//                           label={item.label}
//                           isActive={location.pathname === item.to}
//                           onMouseEnter={() => setHoveredTooltip(`menu-${item.to}`)}
//                           onMouseLeave={() => setHoveredTooltip(null)}
//                         />
//                       </Tooltip>
//                     ))}
...
// import { Link, useLocation, useNavigate } from "react-router-dom";
// import { useDispatch, useSelector } from "react-redux";
// import { fetchOrgById, fetchOrgByName, logoutOrganization } from "../../../redux/Organization/auth/organizationAuthSlice";
// import NotificationDropdown from "../../Admin/Dropdowns/NotificationDropdown";
// import UserDropdown from "../../Admin/Dropdowns/UserDropdown";
...
//   // Get orgName and currentOrg from Redux state
//   // const orgName = useSelector((state) => state.organization.auth.orgName) || localStorage.getItem("orgName");
//   // const currentOrg = useSelector((state) => state.organization.auth.currentOrg);
//   const {orgName, currentOrg, orgId} = useSelector((state) => state.organization.auth);
...
//             >
//               <span className="text-lg font-semibold bg-gray-800 bg-clip-text text-transparent">
//                 {currentOrg?.name ||  orgName || "Organization"}
//               </span>
//             </Link>
//             <Tooltip title={sidebarExpanded ? "Collapse Sidebar" : "Expand Sidebar"} isVisible={!sidebarExpanded}>
//               <button
...
//                 </div>
//                 <div>
//                   <div className="font-medium text-gray-900">{currentOrg?.name || orgName || "Organization"}</div>
//                   <div className="text-sm text-gray-500">Administrator</div>
//                 </div>
//               </div>
//             </div>
