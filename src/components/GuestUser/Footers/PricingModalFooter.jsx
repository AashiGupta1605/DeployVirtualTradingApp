    ...
    {/* <div className="relative min-h-screen flex items-center justify-center bg-gray-900"> */}
      ...
      {isVisible && (
        <div className="fixed inset-0 bg-transparent z-50 flex justify-center items-end">
          {/* Modal Content */}
          <div
            className={`w-full h-1/2 bg-white overflow-y-auto rounded-t-2xl shadow-lg p-6 transition-transform duration-500 ${
              isVisible ? "translate-y-0" : "translate-y-full"
            }`}
          >
            <h2 className="text-xl font-bold text-center text-gray-600 mb-4">Trading Pricing</h2>
            <Pricing/>
            ...
            <button
            onClick={() => setIsVisible(false)}
            className="absolute top-3 right-5 text-bold w-10 p-2 hover:bg-gray-100 rounded-xl transition-colors duration-200"
          >
