...
//           <div className="relative w-full pr-4 max-w-full flex-grow flex-1 min-w-0">
//             <h5 className="text-blueGray-400 uppercase font-bold text-xs truncate">
//               {statSubtitle}
//             </h5>
//             <span className="font-semibold text-lg sm:text-xl text-blueGray-700 line-clamp-1">
//               {statTitle}
//             </span>
//           </div>
//           <div className="relative w-auto pl-4 flex-initial">
...
//           </div>
//         </div>
//         <p className="text-sm text-blueGray-400 mt-4 line-clamp-2">
//           <span className={`${statPercentColor} mr-2`}>
//             <i
//               className={
//                 statArrow === "up"
