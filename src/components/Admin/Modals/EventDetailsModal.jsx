...
const EventDetailsModal = ({ isOpen, onClose, event, onEdit, onDelete }) => {
  ...
  const getIconComponent = (iconName, size = 24, className = "") => {
    const icons = {
      Trophy: <Trophy className={`text-white-600 ${className}`} size={size} />,
      ...
      <div className="relative w-full max-w-[60%] max-h-[80%] mx-2 my-4 bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden flex flex-col">
        ...
        <div className="p-6 border-b border-gray-200 flex justify-between items-center bg-white">
          <div className="flex items-center space-x-4">
            <div className="p-2 bg-lightBlue-600 rounded-xl">
        ...
        <div className="overflow-y-auto flex-1">
          <div className="p-6 grid md:grid-cols-2 gap-8">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-4 rounded-lg">
                <h3 className="text-lg font-semibold text-gray-800 mb-3 flex items-center">
                  <Award className="mr-2 text-lightBlue-600" size={18} />
                  Prize Breakdown
                </h3>
        ...
        <div className="bg-gray-50 border-t border-gray-200 p-4 flex justify-between items-center">
          ...
          <div className="flex space-x-3">
            <button
              onClick={onEdit}
              className="px-4 py-2 rounded-lg bg-lightBlue-600 text-white hover:bg-lightBlue-700 transition-colors flex items-center"
            >
